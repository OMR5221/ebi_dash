...
def read_all_daily():
    ...
    dailyDonors = VW_INT_Agg_DailyDonorsPerLocation.query \
        .order_by(VW_INT_Agg_DailyDonorsPerLocation.lname) \
        .all()
...
def read_all_monthly():
    ...
    """
    # Create the list of people from our data
    monthlyDonors = VW_INT_Agg_MonthlyDonorsPerLocation.query \
        .order_by(VW_INT_Agg_MonthlyDonorsPerLocation.lname) \
        .all()
